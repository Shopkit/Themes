...
{% macro product_list(product) %}
    ...
    <article class="product product-id-{{ product.id }} {{ product.status_alias }} {{ card_hover_effect }} {{ show_product_second_image }} {{ product.image.video_url ? 'has-video' : '' }}" data-id="{{ product.id }}">
