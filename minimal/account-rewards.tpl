...
{% block content %}
    ...
    <div class="{{ layout_container }}">
        <div class="row">
            <div class="col-sm-3">
                <div class="panel well-featured margin-bottom {{ store.theme_options.well_featured_shadow }}">
            ...
            <div class="col-sm-8 col-sm-offset-1">
                ...
                <h3 class="margin-bottom margin-top-0 text-muted-dark light">{{ 'lang.storefront.account.rewards.history'|t }}</h3>
