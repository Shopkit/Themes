															...
															<tr>
																<td width="100%" align="left" valign="top" style="line-height:18px;font-size:14px;">
																	<div style="margin:20px;">
																		...
																		<p style="color:#666;font-size:14px;">
																			O pagamento da encomenda com o número <strong>{{ email_data.order.id }}</strong> falhou.
																		</p>
																		...
																		<p style="color:#666;font-size:14px;">Pode alterar o <a href="{{ email_data.change_payment_url }}">método de pagamento</a> para concluir a encomenda.</p>
																	</div>
																</td>
															</tr>
														</table>
