...
{% block content %}
	...
	<div class="row">
		...
		<div class="span4">
			<a href="{{ product.image.full }}" class="box-medium fancy" rel="{{ product.id }}"><img src="{{ product.image.full }}" alt="{{ product.title }}"></a>
		...
		<div class="span5">
			...
			{{ form_open_cart(product.id, { 'class' : 'well form-inline form-cart' }) }}
				...
				{% if product.reference %}
					<h6><small>Referência: {{ product.reference }}</small></h6>
				{% endif %}
