                                ...
                                {{ form_open(site_url('signup/post'), { 'method' : 'post', 'class' : 'shopkit-auth-form shopkit-auth-form-signup ignore-ajax' }) }}
                                    ...
                                    <div class="row-fluid">
                                        ...
                                        <div class="span12 text-center">
                                            <button type="submit" class="button btn-primary {{ store.theme_options.button_primary_shadow }} shopkit-auth-btn-submit">{{ 'lang.storefront.login.signup.create_account.button'|t }}</button>
                                        </div>
                                    </div>
                                {{ form_close() }}
                            </div>
                    ...
                    <div class="span6">
                        <div class="shopkit-auth-form-login-info ">
                            <div class="login-register-title text-center">
                                ...
                                <a href="{{ site_url('signin') }}" class="button btn-default {{ store.theme_options.button_default_shadow }}">{{ 'lang.storefront.login.signin.title'|t }}</a>
                            </div>
                        </div>
                    </div>
