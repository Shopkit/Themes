						...
						<div class="price">
							...
							{% else %}
								{% if product.promo == true %}
									<span class="data-product-price" data-price="{{ product.price_promo }}">{{ product.price_promo | money_with_sign }}</span>
									<del>{{ product.price | money_with_sign }}</del>
								{% else %}
									<span class="data-product-price" data-price="{{ product.price }}">{{ product.price | money_with_sign }}</span>
									<del></del>
								{% endif %}
							{% endif %}
						</div>
