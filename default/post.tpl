...
{% block content %}
	...
	<div class="share visible-desktop">
		...
		<a target="_blank" href="https://twitter.com/share?url={{ blog_post.url }}&text={{ blog_post.excerpt|url_encode }}" class="text-muted"><i class="fa fa-twitter fa-fw fa-lg"></i></a> &nbsp;
