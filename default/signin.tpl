                        ...
                        {{ form_open(site_url('signin/post') ~ (get.next ? '?next=' ~ get.next), { 'method' : 'post', 'class' : 'shopkit-auth-form shopkit-auth-form-login ignore-ajax' }) }}
                            ...
                            <div class="row-fluid">
                                ...
                                <div class="span12 text-center">
                                    <button type="submit" class="btn btn-primary {{ store.theme_options.button_primary_shadow }}">{{ 'lang.storefront.login.signin.login_account.button'|t }}</button>
                                </div>
                            </div>
                        {{ form_close() }}
            ...
            <div class="span6">
                <div class="shopkit-auth-form-register-info">
                    <div class="login-register-title">
                        <h3 class="title margin-top margin-bottom-lg text-center">{{ 'lang.storefront.signin.no_account.text'|t }}<br>{{ 'lang.storefront.signin.no_account.signup'|t }}</h3>
                        ...
                        <div class="text-center">
                            <a href="{{ site_url('signup') }}" class="btn btn-default {{ store.theme_options.button_default_shadow }}">{{ 'lang.storefront.login.signup.create_account.button'|t }}</a>
                        </div>
                    </div>
                </div>
            </div>
