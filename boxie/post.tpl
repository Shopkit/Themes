                    ...
                    <div class="post-detail well-featured {{ store.theme_options.well_featured_shadow }}">
                        ...
                        {% if blog_post.image %}
                            <div class="image-post">
                                <img src="{{ assets_url('assets/store/img/no-img.png') }}" data-src="{{ blog_post.image.full }}" alt="{{ blog_post.image.alt ? blog_post.image.alt : blog_post.title|e_attr }}" title="{{ blog_post.title|e_attr }}" class="img-responsive lazy">
                            </div>
                        {% endif %}
