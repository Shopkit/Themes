                            ...
                            <div class="checkout-container well-featured {{ store.theme_options.well_featured_shadow }}">
                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <div class="mobile-cart well-featured {{ store.theme_options.well_featured_shadow }} margin-bottom d-block d-md-none">
                                            {% for item in cart.items %}
                                                <div class="cart-item margin-bottom-0" data-product="{{ item.product_id }}" data-product-option="{{ item.options|keys[0] }}">
                                ...
                                <div class="row margin-top word-break">
                                    <div class="col-sm-6">
                                ...
                                <div class="confirm-data margin-top word-break">
                                    <div class="row">
